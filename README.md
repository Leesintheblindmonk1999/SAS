...
_Last automated update / Última actualización automática:_ `2026-05-13T08:37:46+00:00`

### English

| Signal | Value |
|---|---:|
| API product requests, last 24h | `399` |
| Successful requests, last 24h | `340` |
| 4xx errors, last 24h | `55` |
| 5xx errors, last 24h | `4` |
| Unique anonymized users, last 24h | `43` |
| API product requests, last 7d | `399` |
| Detected country buckets | `AR=211, US=145, unknown=35, HK=5, NL=2, BE=1` |
...
| Señal | Valor |
|---|---:|
| Requests de producto, últimas 24h | `399` |
| Requests exitosas, últimas 24h | `340` |
| Errores 4xx, últimas 24h | `55` |
| Errores 5xx, últimas 24h | `4` |
| Usuarios anonimizados únicos, últimas 24h | `43` |
| Requests de producto, últimos 7d | `399` |
| Países detectados | `AR=211, US=145, unknown=35, HK=5, NL=2, BE=1` |
